...
% 
% EEG_manifold_final = selectedROI(EEG_manifold_final,roi,signal_name);
...
%     'Pz', 'P1','P2','P3','P4','P5','P6','P7','P8'};
% 
% EEG_meanALL = selectedROI(EEG_meanALL,roi,signal_name);
...
saveDir = pwd;
save(fullfile(saveDir, 'ROI_ERP_Final_ERP_CSP4_REDUCT.mat'), 'result');
