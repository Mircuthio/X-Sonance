...
for j = 1:size(data_eeg,1)
    filtered_data(j,:,1) = filtfilt(sos,g,data_eeg(j,:));
end
...
% filtering each eeg from different channels/trials/runs
for j = 1:size(data_eeg,1)
    filtered_data(j,:,2) = filtfilt(sos,g,data_eeg(j,:));
end
...
% filtering each eeg from different channels/trials/runs
for j = 1:size(data_eeg,1)
    filtered_data(j,:,3) = filtfilt(sos,g,data_eeg(j,:));
end
...
% filtering each eeg from different channels/trials/runs
for j = 1:size(data_eeg,1)
    filtered_data(j,:,4) = filtfilt(sos,g,data_eeg(j,:));
end
...
% filtering each eeg from different channels/trials/runs
for j = 1:size(data_eeg,1)
    filtered_data(j,:,5) = filtfilt(sos,g,data_eeg(j,:));
end
...
% filtering each eeg from different channels/trials/runs
for j = 1:size(data_eeg,1)
    filtered_data(j,:,6) = filtfilt(sos,g,data_eeg(j,:));
end
...
% filtering each eeg from different channels/trials/runs
for j = 1:size(data_eeg,1)
    filtered_data(j,:,7) = filtfilt(sos,g,data_eeg(j,:));
