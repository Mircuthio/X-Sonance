...
chanLabels = { ...
    'Fp1', 'Fp2', 'Fpz', 'AF7', 'AF3', 'AF8', 'AF4', 'AFz', 'Fz', 'F1', ...
    'F2', 'F3', 'F4', 'F5', 'F6', 'F7', 'F8', 'FC1', 'FC2', 'FC3', ...
    'FC4', 'FC5', 'FC6', 'FCz', 'C1', 'C2', 'C3', 'C4', 'C5', 'C6', ...
    'Cz', 'T7', 'T8', 'FT7', 'FT8', 'TP7', 'TP8', 'CP1', 'CP2', 'CP3', ...
    'CP4', 'CP5', 'CP6', 'CPz', 'P1', 'P2', 'P3', 'P4', 'P5', 'P6', ...
    'P7', 'P8', 'P9', 'P10', 'Pz', 'PO7', 'PO3', 'PO8', 'PO4', 'POz', ...
    'O1', 'O2', 'Oz', 'Iz' ...
};
% chanLabels = { ...
%     'Fz' 'FCz' 'Cz' 'Pz' 'CPz'};

cfgCreatSubj.chanLabels = chanLabels;
cfgCreatSubj.nSub = 15;
cfgCreatSubj.condNames = {'consonant','dissonant'};
cfgCreatSubj.nTrialPerCond = 60;
cfgCreatSubj.tstart = -300;
cfgCreatSubj.tend = 900;
subj_list = Create_dummyEEG_consdiss_data(cfgCreatSubj);

step2_outdir = fullfile(pwd,'MAIN','PROVADUMMY','EXAMPLE',sprintf('SUBJECT_%d',cfgCreatSubj.nSub));
%% 3) PARAMETERS
%% ERP ANALYSES
%
% 1. Subject-level ERP
